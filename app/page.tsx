      ...
      <div className="mt-12 padding-x padding-y max-width " id="discover">
        ...
        {allCars.length > 0? (
          <section>
            ...
            {loading && (
              <div className="mt-16 w-full flex-center"><Image src="/loader.svg" width={50} height={50} alt="loader" className="object-contain"/></div>
            )}
            <ShowMore pageNumber={limit/10} isNext={limit > allCars.length} setLimit={setLimit} />
          </section>
        ):(
          <div className="home__error-container">
            <h2 className="text-white-100 text-xl font-bold">oops, no results </h2>
            <p>{allCars?.message}</p>
            </div>
        )}
